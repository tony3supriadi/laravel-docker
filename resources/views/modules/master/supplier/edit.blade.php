            ...
            <form action="{{ url('supplier/'.encrypt($supplier->id)) }}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 py-2">
                        <input type="radio" value="1" name="companies" class="mr-1" {{ $supplier->companies ? 'checked' : '' }} > PERUSAHAAN
                        <span class="mx-2 text-gray">|</span>
                        <input type="radio" value="0" name="companies" class="mr-1" {{ !$supplier->companies ? 'checked' : '' }}> PERORANGAN
                    </div>
                </div>
