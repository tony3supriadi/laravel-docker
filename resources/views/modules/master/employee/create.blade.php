        ...
        <div class="col-md-12">
            ...
            <form action="{{ url('karyawan') }}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="birthplace" value="{{ old('birthplace') }}" class="form-control @error('birthplace') is-invalid @enderror" autofocus autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="date" name="birthdate" value="{{ old('birthdate') }}" class="form-control @error('birthdate') is-invalid @enderror" autofocus autocomplete="off">
                ...
                <div class="form-group row">
                    <label for="salary" class="col-md-3 py-2 text-right">
                        <span class="text-red">*</span> GAJI POKOK :
                    </label>
                    
                    <div class="col-md-6">
                        <input type="text" name="salary" value="{{ old('salary') ? old('salary') : 0 }}" class="form-control @error('salary') is-invalid @enderror" autofocus autocomplete="off">
