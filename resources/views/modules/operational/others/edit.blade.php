...
<section class="p-4">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ url('operasional/lainnya/'.encrypt($operational->id)) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="nominal" value="{{ old('nominal') ? old('nominal') : $operational->nominal }}" class="form-control @error('nominal') is-invalid @enderror" autofocus autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror">{{ old('description') ? old('description') : $operational->description }}</textarea>
