        ...
        <div class="slimscroll-sidebar">
            <ul class="list-unstyled">
                ...
                <li class="<?= $actived == "laporan" ? 'active' : '' ?>">
                    <a href="#laporan-dropdown" aria-expanded="<?= $actived == "laporan" ? 'true' : 'false' ?>" data-toggle="collapse" class="<?= $actived == "laporan" ? '' : 'collapsed' ?>">
                        <i class="fa fa-clipboard"></i>
                        Laporan
                    </a>

                    <ul id="laporan-dropdown" class="collapse list-unstyled <?= $actived == "laporan" ? 'show' : '' ?>">
                        <li>
                            <a href="{{ url('laporan') }}">
                                <i class="fa fa-angle-double-right"></i>
                                Laba / Rugi
                        ...
                        <li>
                            <a href="{{ url('laporan/hutang') }}">
                                <i class="fa fa-angle-double-right"></i>
                                Hutang
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('laporan/piutang') }}">
                                <i class="fa fa-angle-double-right"></i>
                                Piutang
                            </a>
                        </li>
